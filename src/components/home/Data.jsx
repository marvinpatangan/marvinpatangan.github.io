...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Jan Marvin Patangan
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">I'm a Computer Engineering Graduate from the Polytechnic University of the Philippines</p>
